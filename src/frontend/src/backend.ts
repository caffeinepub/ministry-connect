...
export class Backend implements backendInterface {
    ...
    async getPrayer(arg0: PrayerId): Promise<PrayerEntry> {
        if (this.processError) {
            try {
    ...
    async getPrayerHistory(): Promise<Array<PrayerEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrayerHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPrayer(arg0: string): Promise<PrayerId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPrayer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
